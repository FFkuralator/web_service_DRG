...
def init_sample_data():
    ...
    spaces = [
        ...
        (2, "Малый танцзал", "A", "6", "A667", "Компактное пространство для репетиций", "assets/dance2.jpg", "", 1),
        ...
        (7, "Танцевальная студия", "A", "6", "A666", "Просторное помещение для танцев с зеркалами", "assets/dance1.jpg",
         "", 1),
        (8, "Малый танцзал", "A", "6", "A667", "Компактное пространство для репетиций", "assets/dance2.jpg", "", 1),
